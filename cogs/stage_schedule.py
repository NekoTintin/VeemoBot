...
def create_embed_salmon(json_dict: dict) -> Embed:
    ...
    msg.add_field(name="Armes disponibles", inline=False,
                  value=f"{weapons[json_dict[0]['weapons'][0]]}\n{weapons[json_dict[0]['weapons'][1]]}\n{weapons[json_dict[0]['weapons'][2]]}\n{weapons[json_dict[0]['weapons'][3]]}\n")
